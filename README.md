...
- **四種音色風格**：溫暖／廣播主持人（諧波激勵＋兩段壓縮）／清亮／自然
...
| 項目 | 結果 |
|------|------|
| 降噪・標準 | 訊噪比 10.1 → **19.6 dB** |
| 降噪・加強 | 訊噪比 10.1 → **24.8 dB** |
| 降噪・最強（三層＋噪音門） | 訊噪比 10.1 → **32.6 dB**（噪音底層 -49 dB） |
| 廣播主持人音色（含噪音門） | 訊噪比 **26.9 dB**，響度 -14.5 LUFS |
